def AddGluGluHToBBSamples(samples):
    ...
    samples['ggHto2B_PT-200_M-125'] = [
        '/GluGluHto2B_PT-200_M-125_TuneCP5_13p6TeV_powheg-minlo-pythia8/Run3Summer22EEMiniAODv4-130X_mcRun3_2022_realistic_postEE_v6-v2/MINIAODSIM',
        ['isMC=True'],
        'EventAwareLumiBased',
        100000
    ]
    ...
    samples['ggHto2B_PT-200_M-125_ext'] = [
        '/GluGluHto2B_PT-200_M-125_TuneCP5_13p6TeV_powheg-minlo-pythia8/Run3Summer22EEMiniAODv4-130X_mcRun3_2022_realistic_postEE_v6_ext1-v2/MINIAODSIM',
        ['isMC=True'],
        'EventAwareLumiBased',
        100000
    ]
...
def AddGluGluHHTo4BSamples(samples):
    ...
    samples['ggHHto4B_kl-1p00_kt-1p00_c2-0p00'] = [
        '/GluGlutoHHto4B_kl-1p00_kt-1p00_c2-0p00_TuneCP5_13p6TeV_powheg-pythia8/Run3Summer22EEMiniAODv4-Poisson60KeepRAW_130X_mcRun3_2022_realistic_postEE_v6-v2/MINIAODSIM',
        ['isMC=True'],
        'EventAwareLumiBased',
        100000
    ]
...
def AddDataSamples(samples):
    ...
    samples['JetMET-Run2022E'] = [
        '/JetMET/Run2022E-22Sep2023-v1/MINIAOD',
        ['isMC=False'],
        'LumiBased',
        100
    ]
    samples['JetMET-Run2022F'] = [
        '/JetMET/Run2022F-22Sep2023-v2/MINIAOD',
        ['isMC=False'],
        'LumiBased',
        100
    ]
    samples['JetMET-Run2022G'] = [
        '/JetMET/Run2022G-22Sep2023-v2/MINIAOD',
        ['isMC=False'],
        'LumiBased',
        100
    ]
