def AddGluGluHToBBSamples(samples):
    ...
    samples['ggHto2B_PT-200_M-125'] = [
        '/GluGluHto2B_PT-200_M-125_TuneCP5_13p6TeV_powheg-minlo-pythia8/Run3Summer23BPixMiniAODv4-130X_mcRun3_2023_realistic_postBPix_v2-v2/MINIAODSIM',
        ['isMC=True'],
        'EventAwareLumiBased',
        150000,
        ''
...
def AddGluGluHHTo4BSamples(samples):
    ...
    samples['ggHHto4B_kl-1p00_kt-1p00_c2-0p00'] = [
        '/GluGlutoHHto4B_kl-1p00_kt-1p00_c2-0p00_TuneCP5_13p6TeV_powheg-pythia8/Run3Summer23BPixMiniAODv4-130X_mcRun3_2023_realistic_postBPix_v6-v2/MINIAODSIM',
        ['isMC=True'],
        'EventAwareLumiBased',
        150000,
        ''
...
def AddVJetsSamples(samples):
    samples['Zto2Q-4Jets_HT-200to400'] = [
        '/Zto2Q-4Jets_HT-200to400_TuneCP5_13p6TeV_madgraphMLM-pythia8/Run3Summer23BPixMiniAODv4-130X_mcRun3_2023_realistic_postBPix_v2-v1/MINIAODSIM',
        ['isMC=True'],
        'EventAwareLumiBased',
        150000,
        ''
    ...
    samples['Zto2Q-4Jets_HT-400to600'] = [
        '/Zto2Q-4Jets_HT-400to600_TuneCP5_13p6TeV_madgraphMLM-pythia8/Run3Summer23BPixMiniAODv4-130X_mcRun3_2023_realistic_postBPix_v2-v2/MINIAODSIM',
        ['isMC=True'],
        'EventAwareLumiBased',
        150000,
        ''
    ...
    samples['Zto2Q-4Jets_HT-600to800'] = [
        '/Zto2Q-4Jets_HT-600to800_TuneCP5_13p6TeV_madgraphMLM-pythia8/Run3Summer23BPixMiniAODv4-130X_mcRun3_2023_realistic_postBPix_v2-v1/MINIAODSIM',
        ['isMC=True'],
        'EventAwareLumiBased',
        150000,
        ''
    ...
    samples['Zto2Q-4Jets_HT-800'] = [
        '/Zto2Q-4Jets_HT-800_TuneCP5_13p6TeV_madgraphMLM-pythia8/Run3Summer23BPixMiniAODv4-130X_mcRun3_2023_realistic_postBPix_v2-v1/MINIAODSIM',
        ['isMC=True'],
        'EventAwareLumiBased',
        150000,
        ''
...
def AddDataSamples(samples):
    ...
    samples['JetMET0-Run2023D-v1'] = [
        '/JetMET0/Run2023D-22Sep2023_v1-v1/MINIAOD',
        ['isMC=False'],
        'LumiBased',
        50,
        'Run2023Dv1-22Sep2023'
    ]

    samples['JetMET1-Run2023D-v1'] = [
    ...
    samples['JetMET0-Run2023D-v2'] = [
        '/JetMET0/Run2023D-22Sep2023_v2-v1/MINIAOD',
        ['isMC=False'],
        'LumiBased',
        50,
        'Run2023Dv2-22Sep2023'
    ]

    samples['JetMET1-Run2023D-v2'] = [
