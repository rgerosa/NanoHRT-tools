...
cut_dict_ak8 = {
    ...
    'qcd': 'Sum$((Jet_pt>25 && abs(Jet_eta)<2.4 && (Jet_jetId & 2)) * Jet_pt)>200 && Sum$(FatJet_pt>200 && abs(FatJet_eta)<2.5 && (FatJet_jetId & 2))>0',
    'muon': 'Sum$(Muon_pt>55 && abs(Muon_eta)<2.4 && Muon_tightId && Muon_miniPFRelIso_all<0.10)>0 && Sum$(FatJet_pt>200 && abs(FatJet_eta)<2.5 && (FatJet_jetId & 2))>0',
    'diboson': '(Sum$(Electron_pt>20 && abs(Electron_eta)<2.5 && abs(Electron_dxy)<0.05 && abs(Electron_dz)<0.2 && Electron_mvaFall17V2noIso_WP90 && Electron_miniPFRelIso_all<0.4)>=2 || Sum$(Muon_pt>20 && abs(Muon_eta)<2.4 && abs(Muon_dxy)<0.05 && abs(Muon_dz)<0.2 && Muon_looseId && Muon_miniPFRelIso_all<0.4) >= 2) && Sum$(FatJet_pt>200 && abs(FatJet_eta)<2.5 && (FatJet_jetId & 2))>0',
    ...
    'higgs': 'Sum$((Jet_pt>25 && abs(Jet_eta)<2.4 && (Jet_jetId & 2)) * Jet_pt)>200 && Sum$(FatJet_pt>200 && abs(FatJet_eta)<2.5 && (FatJet_jetId & 2))>0',
    'mutagged': 'Sum$((Jet_pt>25 && abs(Jet_eta)<2.4 && (Jet_jetId & 2)) * Jet_pt)>200 && Sum$(FatJet_pt>200 && abs(FatJet_eta)<2.5 && (FatJet_jetId & 2))>0',
}
cut_dict_ak15 = {
